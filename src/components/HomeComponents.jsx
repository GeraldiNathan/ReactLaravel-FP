  ...
  return (
    <>
      ...
      <section className="bg-orange min-h-screen items-center">
        ...
        <h3 className="text-3xl mt-8 font-bold leading-normal text-cream text-center">
          Why Choose Our <span className="text-hijau">Food?</span>
        </h3>
        <div className="flex flex-wrap ">
          <div className="lg:pt-6 pt-6 w-full md:w-4/12 px-4 text-center">
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
              <div className="px-4 py-5 flex-auto transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-cream">
                <img
                  ...
                  stroke="currentColor"
                />
                <h6 className="text-xl font-semibold">Healthier</h6>
                <p className="mt-2 mb-4 text-gray-600">
            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
              <div className="px-4 py-5 flex-auto transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-cream">
                <img
                  ...
                  stroke="currentColor"
                />
                <h6 className="text-xl font-semibold">Super Taste</h6>
                <p className="mt-2 mb-4 text-gray-600">
            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
              <div className="px-4 py-5 flex-auto transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-cream">
                <img
                  ...
                  stroke="currentColor"
                />
                <h6 className="text-xl font-semibold">Best Recipes</h6>
                <p className="mt-2 mb-4 text-gray-600">
